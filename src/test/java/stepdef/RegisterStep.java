...
public class RegisterStep 
{
	...
	public void open_register_page_of_opencart_application() {
	...
	public void i_enter_required_field_with_valid_data(DataTable table) {
		...
		driver.findElement(By.name("email")).sendKeys(dt.get(1).get(2));
